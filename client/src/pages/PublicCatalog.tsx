...
export default function PublicCatalog() {
  ...
  return <div className="min-h-screen bg-[#f5f7f8] text-[#102c3d]">
    <main className="mx-auto max-w-[1440px] px-4 py-5 sm:px-6 sm:py-8 lg:px-10 lg:py-10">
      ...
      <section className="mb-10 rounded-3xl border border-[#dce8df] bg-white p-6 shadow-sm sm:p-8"><div className="flex items-start gap-4"><div className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-[#102c3d] text-white"><Link2 className="h-5 w-5" /></div><div><p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#b38b3d]">Compartilhamento profissional</p><h2 className="mt-2 text-2xl font-semibold tracking-tight text-[#102c3d] sm:text-3xl">Compartilhe com seus clientes!</h2><p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-600">Compartilhe com seus clientes através de uma página personalizada com a sua identidade profissional, com seu nome, foto, Creci e WhatsApp.</p><a href={`${publicBase}?acesso=login`} className="mt-5 inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-[#20bd63] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#12934a]"><LogIn className="h-4 w-4" /> Entrar na área do corretor</a></div></div></section>
