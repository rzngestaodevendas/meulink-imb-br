...
type Property = { id: number; slug: string; title: string; address: string | null; responsibleName?: string | null; responsiblePhone?: string | null; details: string[]; price: string | null; notes: string | null; photos: string[]; status: Status; publicEnabled: boolean; sourceDriveUrl?: string | null; commission?: string | null };
type FormState = { title: string; address: string; responsibleName: string; responsiblePhone: string; details: string; price: string; notes: string; commission: string; photos: string; status: Status; publicEnabled: boolean };
...
const blankForm: FormState = { title: "", address: "", responsibleName: "", responsiblePhone: "", details: "", price: "", notes: "", commission: "", photos: "", status: "available", publicEnabled: true };
